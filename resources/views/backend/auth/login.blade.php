...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-2"
         id="m_login" style="background-image: url(/adminLTE//assets/app/media/img//bg/bg-3.jpg);">
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container">
                <div class="m-login__signin">
                    <div class="m-login__head">
                        <h3 class="m-login__title">Авторизуйтесь для начала работы {!! config('project.name') !!}</h3>
                    </div>

                    <form class="m-login__form m-form ajax-submit" action="{{route('admin.post.login')}}" method="post"
...
<!--end::Base Scripts -->
<!--begin::Page Snippets -->
<script src="/adminLTE/assets/snippets/pages/user/login.js" type="text/javascript"></script>
