<div class="col-md-6 image-{{$media->id}}" style="margin-top: 5px;margin-bottom: 5px">
    ...
    <div class="text-center">
        <a href="{{ route('admin.content.news.image.crop', ['mediaId' => $media->id ] ) }}" class="handle-click" data-type="modal" data-modal="#editImageModal">
    ...
    <div class="controls" style="margin-top: 10px;">
        ...
        <a @if($media->main_image) style="display: none" @endif class="make-main-image btn btn-sm btn-info pull-left" href="{{route('admin.content.news.main.media',['itemId'=> $media->imageable_id, 'mediaId'=>$media->id])}}">Главная</a>
    </div>
</div>