            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{{ route('admin.categories.create', ['owner' => 'news']) }}"
                           data-type="modal"
                           data-modal="#largeModal"
                           class="m-portlet__nav-link m-portlet__nav-link--icon handle-click" data-container="body"
                           data-toggle="m-tooltip" data-placement="top" title="Категории"><i class="la la-clipboard"></i></a>
                    </li>
                    <li class="m-portlet__nav-item">
                        <a href="{{ route('admin.content.news.create') }}" data-type="modal" data-modal="#superLargeModal"
                           class="m-portlet__nav-link m-portlet__nav-link--icon handle-click" data-container="body"
        ...
        <div class="m-section">
            <div class="m-section__content">
                <table class="table table-bordered m-table ajax-content" id="ajaxTable"
                       data-ajax-content-url="{{ route('admin.content.news.list') }}">
